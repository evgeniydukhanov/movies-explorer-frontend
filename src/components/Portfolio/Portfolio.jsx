      ...
      <ul className="portfolio__links">
        <li className="portfolio__link">
          <a
            ...
            rel="noreferrer"
          >
            Статичный сайт <img className="portfolio__link-img" alt="Стрелка" src={Arrow}></img>
          </a>
        </li>
        <li className="portfolio__link">
          <a
            ...
            rel="noreferrer"
          >
            Адаптивный сайт <img className="portfolio__link-img" alt="Стрелка" src={Arrow}></img>
          </a>
        </li>
        <li className="portfolio__link no-border ">
          ...
          >
            ...
            <img className="portfolio__link-img" alt="Стрелка" src={Arrow}></img>
          </a>
        </li>
      </ul>
    </section>
